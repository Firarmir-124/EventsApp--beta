...
import { Alert, Avatar, Box, Button, Container, Grid, IconButton, Paper, TextField, Typography } from '@mui/material';
  ...
  return (
    <Container>
      ...
      >
        ...
        <Box component="form" sx={{ mt: 3, width: '50%' }} onSubmit={onSubmit}>
